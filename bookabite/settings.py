...
DATABASES = {
    'default': {
        'ENGINE': os.getenv('POSTGRES_ENGINE_DEV'),
        'NAME': os.getenv('POSTGRES_NAME_DEV'),
    ...
    'homologation' : {
        'ENGINE': os.getenv('POSTGRES_ENGINE_HOM'),
        'NAME': os.getenv('POSTGRES_NAME_HOM'),
        'USER': os.getenv('POSTGRES_USER_HOM'),
        'PASSWORD': os.getenv('POSTGRES_PASSWORD_HOM'),
        'HOST': os.getenv('POSTGRES_HOST_HOM'),
        'PORT': os.getenv('POSTGRES_PORT_HOM'),
        'ATOMIC_REQUESTS': True,
    },
    'production' : {
