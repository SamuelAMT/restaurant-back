    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('RESTAURANTCUSTOMER', 'RestaurantCustomer'), ('ADMIN', 'Admin'), ('RESTAURANT', 'Restaurant'), ('RESTAURANTEMPLOYEE', 'RestaurantEmployee')], default='RESTAURANT', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('accounts', models.ManyToManyField(related_name='restaurants', to='custom_auth.account')),
                ...
                ('sessions', models.ManyToManyField(related_name='restaurants', to='custom_auth.session')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('RESTAURANTCUSTOMER', 'RestaurantCustomer'), ('ADMIN', 'Admin'), ('RESTAURANT', 'Restaurant'), ('RESTAURANTEMPLOYEE', 'RestaurantEmployee')], default='RESTAURANTEMPLOYEE', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
