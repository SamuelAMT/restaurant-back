    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('SUPERADMIN', 'Super Admin'), ('RESTAURANT_ADMIN', 'Restaurant Admin'), ('RESTAURANT_SUB_ADMIN', 'Restaurant Sub Admin'), ('RESTAURANT_STAFF', 'Restaurant Staff')], default='RESTAURANT_ADMIN', max_length=20)),
