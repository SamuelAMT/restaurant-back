...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='parent',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='subcategories', to='restaurant.restaurantcategory'),
        ),
        migrations.AddField(
            model_name='restaurant',
            name='category',
        ...
        migrations.AddField(
            model_name='restaurantcuisinetype',
            name='parent',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='subcuisines', to='restaurant.restaurantcuisinetype'),
        ),
        migrations.AddField(
            model_name='restaurant',
            name='cuisine_types',
            field=models.ManyToManyField(related_name='restaurants', to='restaurant.restaurantcuisinetype'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='restaurantemployee',
            name='unit',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='unit_employees', to='unit.unit'),
        ),
        migrations.AddIndex(
            model_name='restaurant',
